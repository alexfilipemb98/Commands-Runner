    ...
    public partial class Main : RibbonForm
    {
        ...
        private void bbiTogglePassword_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            if (newPage == npPasswords)
            {
                ...
                btsEditModePasswords.Visibility = BarItemVisibility.Always;
            }
            else
            {
                LoadCommands();
                bbiTogglePassword.Caption = "Show Passwords";
                btsEditModePasswords.Visibility = BarItemVisibility.Never;
        ...
        private void repositoryItemButtonEdit2_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            if (gvPasswords.GetFocusedRow() is PasswordsModel passwordsModel)
            {
                ...
                else if (e.Button.Tag?.ToString() == "COPY")
                {
                    ...
                    bsiStatus.ItemAppearance.Normal.ForeColor = Color.Green;
                    bsiStatus.Caption = "Password copied to clipboard!";
                }
            }
        }
        ...
        public void ConvertHtmlFilesToPng(string folderPath)
        {
